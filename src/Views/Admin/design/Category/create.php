...
<div class="container main-admin h-screen overflow-y-lg-auto flex-grow-1">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-6">
            ...
            <?php endif; ?>
            <form method="post" action="<?php url('Admin/category/store') ?>">
                <div class="form-group my-2">
                    <label class="mb-1" for="exampleInputTitle">Tên category</label>
                    <input type="text" class="form-control" id="exampleInputTitle"  placeholder="Tên category " name="name">
                </div>
                <?php
                if(isset($name)):
                    ?>
