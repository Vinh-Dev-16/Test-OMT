                    ...
                    <div class="card-body p-md-5">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <form class="mx-1 mx-md-4" method="post" action="<?php url('User/auth/doRegister') ?>">
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            <input type="text" id="form3Example1c" name="name" class="form-control" placeholder="Nhập vào tên tài khoản" />
                                            <label class="form-label mt-2" for="form3Example1c">Tên tài khoản</label>
                                            <?php
                                            if(isset($name)):
                                                ?>
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            <input type="email" id="form3Example3c" name="email" class="form-control" placeholder="Nhập vào email" />
                                            <label class="form-label mt-2" for="form3Example3c">Email</label>
                                            <?php
                                            if(isset($email)):
                                                ?>
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            <input type="password" id="form3Example4c" name="password" class="form-control" placeholder="Nhập vào password" />
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        <svg class="mb-4 me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="28" height="28"> <path d="M12.917 13C12.441 15.8377 9.973 18 7 18C3.68629 18 1 15.3137 1 12C1 8.68629 3.68629 6 7 6C9.973 6 12.441 8.16229 12.917 11H23V13H21V17H19V13H17V17H15V13H12.917ZM7 16C9.20914 16 11 14.2091 11 12C11 9.79086 9.20914 8 7 8C4.79086 8 3 9.79086 3 12C3 14.2091 4.79086 16 7 16Z"></path></svg>
                                        <div class="form-outline flex-fill mb-0">
                                            <input type="password" name="rePassword" id="form3Example4cd" class="form-control" placeholder="Nhập lại password" />
                                            <label class="form-label mt-2" for="form3Example4cd">Nhập lại password</label>
                                            <?php
                                            if(isset($rePassword)):
                                                ?>
